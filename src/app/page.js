        ...
        <section className='min-h-screen' id="portfolio">
          ...
          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
              <div className="basis-1/3 flex-1 shadow-lg dark:shadow-black">
                <a href="https://www.lulusweetworld.shop/" target='#blank'><Image className="rounded-lg object-cover hover:scale-110 transition duration-500" width={"100%"} height={"100%"} layout="responsive" src={web3}/></a>
              </div>
              <div className="basis-1/3 flex-1 shadow-lg dark:shadow-black">
                <a href="https://lesbellesbranches.vercel.app/" target='#blank'><Image className="rounded-lg object-cover hover:scale-110 transition duration-500" width={"100%"} height={"100%"} layout="responsive" src={web1}/></a>
              </div>
              <div className="basis-1/3 flex-1 shadow-lg dark:shadow-black">
